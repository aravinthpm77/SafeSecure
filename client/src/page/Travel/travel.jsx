...
const Travel =()=>{
    ...
    const products = [
        {type:"Travel",id:1, name: "FIRST", price: "0", details: ["Unlimited updates"] },
        {type:"Travel",id:2, name: "Basic", price: "1099", details: ["Unlimited updates", "Git repository", "npm installation"] },
        {type:"Travel",id:3, name: "Advanced", price: "2499", details: ["Unlimited updates", "Git repository", "npm installation", "Code examples", "Premium snippets"] },
        {type:"Travel",id:4, name: "Enterprise", price: "3499", details: ["Unlimited updates", "Git repository", "npm installation", "Code examples", "Premium snippets", "Premium support", "Drag&Drop builder"] }
    ];
