...
const Auto =()=>{
    ...
    const products = [
        {type:"auto",id:1, name: "FIRST", price: "0", details: ["Unlimited updates"] },
        {type:"auto",id:2, name: "Basic", price: "1099", details: ["Unlimited updates", "Git repository", "npm installation"] },
        {type:"auto",id:3, name: "Advanced", price: "2499", details: ["Unlimited updates", "Git repository", "npm installation", "Code examples", "Premium snippets"] },
        {type:"auto",id:4, name: "Enterprise", price: "3499", details: ["Unlimited updates", "Git repository", "npm installation", "Code examples", "Premium snippets", "Premium support", "Drag&Drop builder"] }
    ];
            ...
            <div>
                ...
                <div className= " container mt-14 h-auto ">
                    <div className="ml-10 mt-16">
                        <h3 className="text-[40px] font-bold font-sans text-left tracking-tighter ">Automobile Insurance</h3>
