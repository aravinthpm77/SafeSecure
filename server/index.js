...
app.post("/create-checkout-session",async(req,res)=>{
    ...
    try{
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: "payment",
            line_items,
            success_url: 'https://safesecure-insurance.vercel.app/success', // Redirect to this URL after successful payment
            cancel_url: 'https://safesecure-insurance.vercel.app/cancel',
